...
sudo cp customdomain/tahap1.conf /usr/lib/cgi-bin
sudo cp customdomain/runtahap1.conf /usr/lib/cgi-bin
sudo cp customdomain/tahap2.conf /usr/lib/cgi-bin
sudo cp customdomain/runtahap1.conf /usr/lib/cgi-bin
sudo cp customdomain/aktivasi5.conf /usr/lib/cgi-bin
sudo cp customdomain/aktivasi7.conf /usr/lib/cgi-bin
